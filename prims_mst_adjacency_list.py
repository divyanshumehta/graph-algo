...
class Graph():
    ...
    def addEdge(self, src, dest, weight):
        ...
        # list of src. The node is added at the begining. The first element of
        # the node has the destination and the second elements has the weight
        newNode = [dest, weight]
    ...
    # The main function that prints the Minimum Spanning Tree(MST)
    # using the Prim's Algorithm. It is a O(ELogV) function
    def PrimMST(self):
